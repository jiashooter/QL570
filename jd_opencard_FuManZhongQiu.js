...
process.env.guaopencard23 = true
process.env.guaopencard_draw23 = true
let cookiesArr = [],
    cookie = '';
let activityCookie = '';
let lz_jdpin_token = '';
...
!(async () => {
  ...
  $.shareUuid = '11a94bdffe3c466f820384470a251fc3'
  $.activityId = 'dz2109100011150101'
  console.log(`入口:\nhttps://lzdz1-isv.isvjd.com/dingzhi/midautumn/jointactivity/activity/6849894?activityId=dz2109100011150101`)
