...
[task_local]
#柠檬赚金币
cron "0 7 * * *" http://nm66.top/jd_zjb.js, tag=柠檬赚金币, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
*/
const $ = new Env('柠檬赚金币');
	...
	for (let i = 0; i < cookiesArr.length; i++) {
		if (cookiesArr[i]) {
			...
			if (InviterPin.length != 0) {
				...
				console.log(`\n您未填写赚金币邀请码变量，开始助力【卡步vs奇诺】\n`);
				await help2("卡步vs奇诺", "sd3jwtYTH6czzYrEVe1r7Q==")
				await help2("jd_53b75edc26542", "p6EmQTyWkZ6PZ0NvBczCPgiCRvAntF62n/WTiWNWBOY=")
