			...
			try {
				if (err) {
					...
					if (data.code == 0 && data.data.sponsorActivityInfo.packetId) {
						console.log(
							`【京东账号${$.index}的推一推邀请码】${data.data.sponsorActivityInfo.packetId}\n`
							)
...
var _0xodD = 'jsjiami.com.v6',
	_0x4246 = [_0xodD, '\x67\x65\x74',
		'',
		...
		'\x61\x75\x74\x68\x6f\x72\x43\x6f\x64\x65', '\x70\x61\x72\x73\x65', '\x6c\x6f\x67\x45\x72\x72',
		'\x6a\x73\x41\x52\x6a\x52\x6b\x71\x69\x57\x4f\x61\x6d\x69\x6b\x2e\x63\x6f\x6d\x56\x4a\x42\x2e\x76\x36\x3d\x3d'
	];
var _0x3dd3 = function(_0x4fdd8e, _0x2bbd52) {
	_0x4fdd8e = ~~'0x' ['concat'](_0x4fdd8e);
	var _0x4aa04a = _0x4246[_0x4fdd8e];
	return _0x4aa04a;
};
(function(_0x4f10de, _0x3c5b1f) {
	var _0x29abd4 = 0x0;
	for (_0x3c5b1f = _0x4f10de['shift'](_0x29abd4 >> 0x2); _0x3c5b1f && _0x3c5b1f !== (_0x4f10de['pop'](_0x29abd4 >>
			0x3) + '')['replace'](/[ARRkqWOkVJB=]/g, ''); _0x29abd4++) {
		_0x29abd4 = _0x29abd4 ^ 0x98130;
	}
}(_0x4246, _0x3dd3));

function getAuthorShareCode() {
	return new Promise(_0x456c8e => {
		$[_0x3dd3('0')]({
			'\x75\x72\x6c': _0x3dd3('1'),
			'\x68\x65\x61\x64\x65\x72\x73': {
				'User-Agent': _0x3dd3('2')
			}
		}, async (_0x590035, _0x5bae1e, _0x1b2379) => {
			try {
				if (_0x590035) {} else {
					$[_0x3dd3('3')] = JSON[_0x3dd3('4')](_0x1b2379);
				}
			} catch (_0x265e68) {
				$[_0x3dd3('5')](_0x265e68, _0x5bae1e);
			} finally {
				_0x456c8e();
			}
		});
