...
let helpnum=process.env.helpnum ? process.env.helpnum : 5;//默认前三组队当车头/膨胀
let groupnum=process.env.groupnum ? process.env.groupnum : 4;//默认4人参队，即一队5人
let num=0;
