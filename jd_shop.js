...
[task_local]
#进店领豆
10 2 * * * jd_shop.js, tag=进店领豆, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_shop.png, enabled=true
================Loon============
[Script]
cron "10 2 * * *" script-path=jd_shop.js,tag=进店领豆
==============Surge===============
[Script]
