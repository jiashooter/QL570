    ...
    $.post(taskPostUrl(), (err, resp, data) => {
      try {
        if (err) {
          ...
          //$.log('openapp.jdmobile://virtual/params='+JSON.stringify({category: 'jump',des: 'ThirdPartyLogin',action: 'to',onekeylogin: 'return',url: url,authlogin_returnurl: 'weixin://',browserlogin_fromurl: '',}))
        }
      } catch (e) {
        $.logErr(e, resp)
      } finally {
